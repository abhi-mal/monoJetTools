...
const std::map<TString,Type> Dataset::datamap = {
  ...
  {"zprime",Signal},{"axial",Signal},{"dmsimp_scalar",Signal},{"dmsimp_pseudoscalar",Signal},{"dmsimp_tchannel_0or1_onshellmediator",Signal},{"dmsimp_tchannel_2_onshellmediators",Signal},{"ADD",Signal},{"leptoquark",Signal},
